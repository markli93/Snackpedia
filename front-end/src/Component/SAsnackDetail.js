...
export default class SAsnackDetail extends React.Component{
    constructor(){
        super();
        this.state ={ 
            item: {},
    ...
    componentDidMount() {
        axios.get(`http://localhost:8080/sa/${this.props.match.params.id}`)
        .then(response => {
            this.setState({
                item: response.data
            })
        ...
        axios.get(`http://localhost:8080/sa/${this.props.match.params.id}/comments`)
        .then(response => {
            this.setState({
    ...
    submitComment = (e)=>{
        ...
        if(this.commentForm.current.userName.value ===''|| this.commentForm.current.userComment.value ===''){
            ...
            axios.post(`http://localhost:8080/sa/${this.props.match.params.id}/comments`,{
    ...
    render(){
        ...
        return(
             <div className="detail__container__sa">
