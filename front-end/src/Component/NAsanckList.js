...
import NAsnackItem from './NAsnackItem';
...
export default class NAsnackList extends React.Component{
    ...
    componentDidMount(){
            axios.get('http://localhost:8080/na')
            .then(res => {
                this.setState({
                    snack: res.data
                });
    ...
    onOpenModal = () => {
      ...
      uploadSnack = e => {
        ...
        axios.post(`http://localhost:8080/na`, data,config)
        .then(res => {
            this.setState({
                snack:res.data
              })
    ...
    render(){
        ...
        return(
            <div className="nasnack--container">
                <Link to="/">
                    <h1>North American Snacks</h1>
                </Link>
