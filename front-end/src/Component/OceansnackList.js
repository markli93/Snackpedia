...
import OceansnackItem from './OceansnackItem';
import Modal from 'react-responsive-modal';
import {Link} from"react-router-dom";

export default class OceansnackList extends React.Component{
    constructor(){
        super();
    ...
    componentDidMount(){
            axios.get('http://localhost:8080/ocean')
            .then(res => {
                this.setState({
                    snack: res.data
                });
    ...
    onOpenModal = () => {
      ...
      uploadSnack = e => {
        ...
        axios.post(`http://localhost:8080/ocean`, data,config)
        .then(res => {
            this.setState({
                snack:res.data
              })
    ...
    render(){
        ...
        return(
            <div className="oceaniasnack--container">
                <Link to="/">
                    <h1>Oceania Snacks</h1>
                </Link>
