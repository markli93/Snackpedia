...
import EuropeansnackItem from './EuropeansnackItem';
import Modal from 'react-responsive-modal';
import {Link} from"react-router-dom";

export default class EuropesnackList extends React.Component{
    constructor(){
        super();
    ...
    componentDidMount(){
            axios.get('http://localhost:8080/europe')
            .then(res => {
                this.setState({
                    snack: res.data
                });
    ...
    onOpenModal = () => {
      ...
      uploadSnack = e => {
        ...
        axios.post(`http://localhost:8080/europe`, data,config)
        .then(res => {
            this.setState({
                snack:res.data
              })
    ...
    render(){
        ...
        return(
            <div className="europeansnack--container">
                <Link to="/">
                    <h1>European Snacks</h1>
                </Link>
