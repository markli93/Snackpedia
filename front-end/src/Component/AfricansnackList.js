...
import AfricansnackItem from './AfricansnackItem';
import Modal from 'react-responsive-modal';
import {Link} from"react-router-dom";

export default class AfricansnackList extends React.Component{
    constructor(){
        super();
    ...
    componentDidMount(){
            axios.get('http://localhost:8080/africa')
            .then(res => {
                this.setState({
                    snack: res.data
                });
    ...
    onOpenModal = () => {
      ...
      uploadSnack = e => {
        ...
        axios.post(`http://localhost:8080/africa`, data,config)
        .then(res => {
            this.setState({
                snack:res.data
              })
    ...
    render(){
        ...
        return(
            <div className="africsnack--container">
                <Link to="/">
                    <h1 id="test">African Snacks</h1>
                </Link>
